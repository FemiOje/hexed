...
export function setupWorld(provider: DojoProvider) {
  ...
  const build_game_systems_spawn_calldata = (
    tokenId: BigNumberish,
  ): DojoCall => {
    return {
      contractName: "game_systems",
  ...
  const game_systems_spawn = async (
    snAccount: Account | AccountInterface,
    tokenId: BigNumberish,
  ) => {
    try {
  ...
  const build_game_token_systems_gameOver_calldata = (
    tokenId: BigNumberish,
  ): DojoCall => {
    return {
  ...
  const game_token_systems_gameOver = async (tokenId: BigNumberish) => {
    try {
      return await provider.call(
        "hexed",
        build_game_token_systems_gameOver_calldata(tokenId),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_game_token_systems_gameOverBatch_calldata = (
  ...
  const game_token_systems_gameOverBatch = async (
    tokenIds: Array<BigNumberish>,
  ) => {
    try {
      return await provider.call(
        "hexed",
        build_game_token_systems_gameOverBatch_calldata(tokenIds),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_game_token_systems_mintGame_calldata = (
    ...
    objectiveId: CairoOption<BigNumberish>,
    context: CairoOption<GameContextDetails>,
    clientUrl: CairoOption<string>,
    rendererAddress: CairoOption<string>,
    skillsAddress: CairoOption<string>,
    to: string,
    soulbound: boolean,
    paymaster: boolean,
    salt: BigNumberish,
  ...
  const game_token_systems_mintGame = async (
    playerName: CairoOption<BigNumberish>,
    settingsId: CairoOption<BigNumberish>,
    start: CairoOption<BigNumberish>,
    end: CairoOption<BigNumberish>,
    ...
    try {
      return await provider.call(
        "hexed",
        build_game_token_systems_mintGame_calldata(
          playerName,
          settingsId,
          start,
          end,
  ...
  const build_game_token_systems_mintGameBatch_calldata = (
  ...
  const game_token_systems_mintGameBatch = async (
    mints: Array<MintGameParams>,
  ) => {
    try {
      return await provider.call(
        "hexed",
        build_game_token_systems_mintGameBatch_calldata(mints),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const game_token_systems_objectivesAddress = async () => {
    try {
      return await provider.call(
        "hexed",
        build_game_token_systems_objectivesAddress_calldata(),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_game_token_systems_score_calldata = (
    tokenId: BigNumberish,
  ): DojoCall => {
    return {
      contractName: "game_token_systems",
  ...
  const game_token_systems_score = async (tokenId: BigNumberish) => {
    try {
      return await provider.call(
        "hexed",
        build_game_token_systems_score_calldata(tokenId),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_game_token_systems_scoreBatch_calldata = (
    tokenIds: Array<BigNumberish>,
  ): DojoCall => {
    return {
      contractName: "game_token_systems",
  ...
  const game_token_systems_scoreBatch = async (
    tokenIds: Array<BigNumberish>,
  ) => {
    try {
      return await provider.call(
        "hexed",
        build_game_token_systems_scoreBatch_calldata(tokenIds),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const game_token_systems_settingsAddress = async () => {
    try {
      return await provider.call(
        "hexed",
        build_game_token_systems_settingsAddress_calldata(),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_game_token_systems_supportsInterface_calldata = (
  ...
  const game_token_systems_supportsInterface = async (
    interfaceId: BigNumberish,
  ) => {
    try {
      return await provider.call(
        "hexed",
        build_game_token_systems_supportsInterface_calldata(interfaceId),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const game_token_systems_tokenAddress = async () => {
    try {
      return await provider.call(
        "hexed",
        build_game_token_systems_tokenAddress_calldata(),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_renderer_systems_gameDetails_calldata = (
    tokenId: BigNumberish,
  ): DojoCall => {
    return {
  ...
  const renderer_systems_gameDetails = async (tokenId: BigNumberish) => {
    try {
      return await provider.call(
        "hexed",
        build_renderer_systems_gameDetails_calldata(tokenId),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_renderer_systems_gameDetailsBatch_calldata = (
    tokenIds: Array<BigNumberish>,
  ): DojoCall => {
    return {
      contractName: "renderer_systems",
  ...
  const renderer_systems_gameDetailsBatch = async (
    tokenIds: Array<BigNumberish>,
  ) => {
    try {
      return await provider.call(
        "hexed",
        build_renderer_systems_gameDetailsBatch_calldata(tokenIds),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_renderer_systems_tokenDescription_calldata = (
    tokenId: BigNumberish,
  ): DojoCall => {
    return {
      contractName: "renderer_systems",
  ...
  const renderer_systems_tokenDescription = async (tokenId: BigNumberish) => {
    try {
      return await provider.call(
        "hexed",
        build_renderer_systems_tokenDescription_calldata(tokenId),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_renderer_systems_tokenDescriptionBatch_calldata = (
    tokenIds: Array<BigNumberish>,
  ): DojoCall => {
    return {
      contractName: "renderer_systems",
  ...
  const renderer_systems_tokenDescriptionBatch = async (
    tokenIds: Array<BigNumberish>,
  ) => {
    try {
      return await provider.call(
        "hexed",
        build_renderer_systems_tokenDescriptionBatch_calldata(tokenIds),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_renderer_systems_tokenName_calldata = (
    tokenId: BigNumberish,
  ): DojoCall => {
    return {
      contractName: "renderer_systems",
  ...
  const renderer_systems_tokenName = async (tokenId: BigNumberish) => {
    try {
      return await provider.call(
        "hexed",
        build_renderer_systems_tokenName_calldata(tokenId),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  const build_renderer_systems_tokenNameBatch_calldata = (
    tokenIds: Array<BigNumberish>,
  ): DojoCall => {
    return {
      contractName: "renderer_systems",
  ...
  const renderer_systems_tokenNameBatch = async (
    tokenIds: Array<BigNumberish>,
  ) => {
    try {
      return await provider.call(
        "hexed",
        build_renderer_systems_tokenNameBatch_calldata(tokenIds),
      );
    } catch (error) {
      console.error(error);
      throw error;
  ...
  return {
    ...
    game_token_systems: {
      ...
      buildGameOverBatchCalldata:
        build_game_token_systems_gameOverBatch_calldata,
      ...
      buildMintGameBatchCalldata:
        build_game_token_systems_mintGameBatch_calldata,
      objectivesAddress: game_token_systems_objectivesAddress,
      buildObjectivesAddressCalldata:
        build_game_token_systems_objectivesAddress_calldata,
    ...
    renderer_systems: {
      ...
      buildGameDetailsBatchCalldata:
        build_renderer_systems_gameDetailsBatch_calldata,
      tokenDescription: renderer_systems_tokenDescription,
      buildTokenDescriptionCalldata:
        build_renderer_systems_tokenDescription_calldata,
      tokenDescriptionBatch: renderer_systems_tokenDescriptionBatch,
      buildTokenDescriptionBatchCalldata:
        build_renderer_systems_tokenDescriptionBatch_calldata,
      ...
      buildTokenNameBatchCalldata:
        build_renderer_systems_tokenNameBatch_calldata,
    },
  };
}
