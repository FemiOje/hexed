...
mod tests {
    ...
    fn test_move_northeast() {
        ...
        world
            .write_model_test(
                @GameSession { token_id: test_token_id, player: caller, is_active: true },
            );
        world
            .write_model_test(
                @PlayerState {
    ...
    fn test_move_to_inactive_defender_tile() {
        ...
        world
            .write_model_test(
                @GameSession {
                    token_id: stale_id, player: 0xdead.try_into().unwrap(), is_active: false,
                },
            );
    ...
    fn test_combat_on_occupied_tile() {
        ...
        world
            .write_model_test(
                @GameSession { token_id: attacker_id, player: attacker_addr, is_active: true },
            );
        world
            .write_model_test(
                @PlayerState {
        ...
        world
            .write_model_test(
                @GameSession { token_id: defender_id, player: defender_addr, is_active: true },
            );
        world
            .write_model_test(
                @PlayerState {
    ...
    fn test_neighbor_occupancy_east() {
        ...
        world
            .write_model_test(
                @GameSession { token_id: neighbor_id, player: defender_addr, is_active: true },
            );
        world
            .write_model_test(
                @PlayerState {
    ...
    fn test_neighbor_occupancy_multiple() {
        ...
        world
            .write_model_test(
                @GameSession { token_id: east_id, player: defender_addr, is_active: true },
            );
        ...
        world
            .write_model_test(
                @GameSession { token_id: west_id, player: defender_addr, is_active: true },
            );
    ...
    fn test_neighbor_occupancy_inactive_ignored() {
        ...
        world
            .write_model_test(
                @GameSession { token_id: stale_id, player: defender_addr, is_active: false },
            );
        world.write_model_test(@TileOccupant { x: 1, y: 0, token_id: stale_id });
    ...
    fn test_encounter_death_by_poison() {
        ...
        while gid < 80 && !found_death {
            ...
            world.write_model_test(@GameSession { token_id: tid, player: caller, is_active: true });
            world
                .write_model_test(
                    @PlayerState {
                        token_id: tid,
    ...
    fn test_encounter_no_combat_on_empty_tile() {
        ...
        world
            .write_model_test(
                @GameSession { token_id: player_id, player: attacker_addr, is_active: true },
            );
        world
            .write_model_test(
                @PlayerState {
    ...
    fn test_encounter_different_positions_different_outcomes() {
        ...
        let id1: felt252 = 100;
        world.write_model_test(@GameSession { token_id: id1, player: caller, is_active: true });
        world
            .write_model_test(
                @PlayerState {
                    token_id: id1,
        ...
        let id2: felt252 = 200;
        world.write_model_test(@GameSession { token_id: id2, player: caller, is_active: true });
        world
            .write_model_test(
                @PlayerState {
                    token_id: id2,
